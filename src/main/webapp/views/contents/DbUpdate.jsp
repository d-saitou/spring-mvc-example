...
<div id="wrapper">
	...
	<%-- Title --%>
	<div id="header">
		<h1><spring:message code="DbUpdate.text.title" /></h1>
	</div>
	...
	<form:form action="${contextPath}/db/update/${taskForm.id}" modelAttribute="taskForm">
		<table class="table-style">
			<tr>
				<th class="table-header"><spring:message code="DbUpdate.th.id" /></th>
				<td class="table-form">${taskForm.id}</td>
			</tr><tr>
				<th class="table-header"><spring:message code="DbUpdate.th.title" /></th>
				<td class="table-form">
					<form:input path="title" cssClass="wide-form" />
					<form:errors path="title" cssClass="errors"></form:errors>
				</td>
			</tr><tr>
				<th class="table-header"><spring:message code="DbUpdate.th.scheduledate" /></th>
				<td class="table-form">
					<form:input path="scheduledate" cssClass="wide-form date-text" />
					<form:errors path="scheduledate" cssClass="errors"></form:errors>
				</td>
			</tr><tr>
				<th class="table-header"><spring:message code="DbUpdate.th.status" /></th>
				<td class="table-form">
					<form:checkbox path="status" />
					<form:errors path="status" cssClass="errors"></form:errors>
				</td>
			</tr><tr>
				<th class="table-header"><spring:message code="DbUpdate.th.description" /></th>
				<td class="table-form">
