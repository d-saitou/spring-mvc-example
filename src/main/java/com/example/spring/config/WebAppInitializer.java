...
import com.example.spring.config.application.AppConfig;
import com.example.spring.config.application.AsyncConfig;
import com.example.spring.config.application.DataSourceConfig;
import com.example.spring.config.application.JpaConfig;
import com.example.spring.config.application.TaskSchedulerConfig;
import com.example.spring.config.application.TransactionAdviceConfig;
import com.example.spring.config.application.WebMvcConfig;
import com.example.spring.config.security.WebSecurityConfig;
