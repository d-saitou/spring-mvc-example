 ...
 *  <ul><li>
 *   {@link com.example.spring.config.WebAppInitializer WebAppInitializer}
 *   : Register DispatcherServlet and Java-based Spring configuration.
 *  </li><li>
 *   {@link com.example.spring.config.application.AppConfig AppConfig}
 *   : Configure the basic configuration of the application.
 *  </li><li>
 *   {@link com.example.spring.config.application.WebMvcConfig WebMvcConfig}
 ...
 *  <ul><li>
 *   {@link com.example.spring.config.SecurityWebAppInitializer SecurityWebAppInitializer}
 *   : Configure and initialize application security.
 *  </li><li>
 *   {@link com.example.spring.config.security.WebSecurityConfig WebSecurityConfig}
 *   : Configure authentication and authorization.
 *  </li><li>
 *   {@link com.example.spring.config.security.UserDetailsImpl UserDetailsImpl}
 *   : User-specific data.
 *  </li><li>
 *   {@link com.example.spring.config.security.UserDetailsServiceImpl UserDetailsServiceImpl}
 *   : Loads user-specific data.
 *  </li><li>
 *   {@link com.example.spring.config.security.AuthenticationSuccessHandlerImpl AuthenticationSuccessHandlerImpl}
 ...
 *  <ul><li>
 *   {@link com.example.spring.config.WebAppInitializer#getCharacterEncodingFilter() WebAppInitializer#getCharacterEncodingFilter()}
 *   : Configure and get CharacterEncodingFilter.
 *  </li><li>
 *   {@link com.example.spring.config.security.WebSecurityConfig#configure(HttpSecurity) WebSecurityConfig#configure(HttpSecurity)}
 ...
 *  <ul><li>
 *   {@link com.example.spring.config.WebAppInitializer#customizeRegistration() WebAppInitializer#customizeRegistration()}
 *   : Enable Multipart request for Servlet 3.0.
 *  </li><li>
 *   {@link com.example.spring.config.SecurityWebAppInitializer#beforeSpringSecurityFilterChain() SecurityWebAppInitializer#beforeSpringSecurityFilterChain()}
 *   : Add MultipartFilter before springSecurityFilterChain.
 *  </li><li>
 *   {@link com.example.spring.config.application.AppConfig#multipartResolver() AppConfig#multipartResolver()}
 ...
 *  <ul><li>
 *   {@link com.example.spring.config.application.DataSourceConfig DataSourceConfig}
 *   : Configure the data source.
 *  </li><li>
 *   {@link com.example.spring.config.application.JpaConfig JpaConfig}
 *   : Configure the basic configuration of the application.
 *  </li><li>
 *   {@link com.example.spring.config.application.TransactionAdviceConfig TransactionAdviceConfig}
 ...
 *  custom annotations ({@link com.example.spring.application.validation validation package}) and
 *  custom validators ({@link com.example.spring.application.di.validator validator package}).
 *  This application configures validation with the following methods:
 *  <ul><li>
 *   {@link com.example.spring.config.application.WebMvcConfig#getValidator() WebMvcConfig#getValidator()}
 ...
 *  </li><li>
 *   {@link com.example.spring.config.application.AsyncConfig AsyncConfig}
 *   : Enable and configure asynchronous requests.
 *  </li><li>
 *   {@link com.example.spring.config.application.WebMvcConfig#configureAsyncSupport() WebMvcConfig#configureAsyncSupport()}
 *   : Configure asynchronous request handling options.
 *  </li><li>
 *   {@link com.example.spring.config.async.CustomCallableProcessingInterceptor CustomCallableProcessingInterceptor}
 *   : Common methods of asynchronous processing using Callable.
 *  </li><li>
 *   {@link com.example.spring.config.async.CustomDeferredResultProcessingInterceptor CustomDeferredResultProcessingInterceptor}
 ...
 *  <ul><li>
 *   {@link com.example.spring.config.application.TaskSchedulerConfig TaskSchedulerConfig}
